...
var module_xlnt = (function() {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  return (
function(module_xlnt) {
  module_xlnt = module_xlnt || {};
...
var Module = typeof module_xlnt !== 'undefined' ? module_xlnt : {};
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'xlnt.wast';
  var wasmBinaryFile = 'xlnt.wasm';
  var asmjsCodeFile = 'xlnt.temp.asm.js';
...
var ASM_CONSTS = [function($0) { fileName = Pointer_stringify($0); fileContent = [FS.readFile(fileName)]; mime = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"; file = new Blob(fileContent, { type: mime }); downloadUrl = URL.createObjectURL(file); anchor = document.createElement('a'); anchor.download = fileName; anchor.href = downloadUrl; anchor.dataset.downloadurl = mime + ":" + fileName + ":" + downloadUrl; document.body.appendChild(anchor); anchor.click(); document.body.removeChild(anchor); },
 function($0) { throw new TypeError(Pointer_stringify($0)); }];
...
STATICTOP = STATIC_BASE + 74784;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { __GLOBAL__sub_I_bindings_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } }, { func: function() { ___emscripten_environ_constructor() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
...
Module['wasmTableSize'] = 987;

Module['wasmMaxTableSize'] = 987;
...
if (typeof exports === 'object' && typeof module === 'object')
    module.exports = module_xlnt;
  else if (typeof define === 'function' && define['amd'])
    define([], function() { return module_xlnt; });
  else if (typeof exports === 'object')
    exports["module_xlnt"] = module_xlnt;
